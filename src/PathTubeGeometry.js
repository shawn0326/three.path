(function() {
    /**
     * THREE.PathGeometry 
     * need drawtype THREE.TriangleDrawMode
     */
    var PathTubeGeometry = function(maxVertex) {
        THREE.PathGeometry.call( this, maxVertex || 1000 );

        this.setIndex( new Array((maxVertex || 1000) * 2) );

    }

    PathTubeGeometry.prototype = Object.assign( Object.create( THREE.PathGeometry.prototype ), {
            ...
            if(progressDistance > 0) {
                for(var i = 0; i < pathPointList.count; i++) {
                    ...
                    if(pathPoint.dist > progressDistance) {
                        ...
                        var lastPoint = new THREE.PathPoint();
